...
const semanticChecks = [
  ...
  ["while statement with variable", "sankhya ginti x = 15; jabtaki (x < 25) { likhana x + 2; x = x + 1; }"],
  ["function declaration", "prakriya doubleIt(ginti x) : ginti { laana x * 2; }"],
  ["function call", "prakriya even(ginti x) : ginti { laana (x % 2 == 0); }", "ginti x = 4; likhana(even(x));"],
